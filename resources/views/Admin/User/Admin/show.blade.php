...
<div class="container p-6 mx-auto">
    ...
    <div class="z-50 p-4 mb-4 bg-white rounded-sm shadow font-heading">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-bold text-purple-800 font-heading">Detail Data Admin</h2>
            <div class="flex space-x-1 font-sans text-xs text-gray-500">
                ...
                <span>/</span>
                <span class="text-gray-400">Detail Admin</span>
            </div>
        </div>
    </div>
    ...
    <div class="w-full p-6 mb-8 bg-white border border-gray-200 rounded-sm shadow-sm drop-shadow">
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="{{ route('admin.index') }}" class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 transition-all duration-200 bg-white border border-gray-300 group rounded-xl hover:bg-gray-50 hover:text-gray-900 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
        ...
        <!-- Profile Section -->
        <div class="mb-6 bg-white border border-gray-200 rounded-sm shadow-sm">
            <div class="p-8 rounded-lg bg-gradient-to-r from-purple-50 to-indigo-50">
                <div class="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        <h1 class="mb-2 text-2xl font-bold text-gray-900">{{ $admin->name }}</h1>
                        <p class="mb-1 text-gray-600">{{ $admin->email }}</p>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="p-8">
                ...
                <div class="mb-8">
                    <h2 class="pb-2 mb-6 text-lg font-semibold text-purple-900 border-b border-gray-200">Informasi Personal</h2>
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <!-- Nama Lengkap -->
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Nama Lengkap</label>
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $admin->name }}</p>
                            </div>
                        </div>
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <div class="flex items-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-1" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
